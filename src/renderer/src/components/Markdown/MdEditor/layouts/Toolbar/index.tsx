...
import Divider from '@renderer/components/Markdown/MdEditor/components/Divider';
...
import { StaticTextDefaultValue, ToolbarNames } from '@renderer/components/Markdown/MdEditor/type';
import { linkTo } from '@vavt/util';
import { ToolDirective } from '@renderer/components/Markdown/MdEditor/utils/content-help';
import { allToolbar, prefix } from '@renderer/components/Markdown/MdEditor/config';
import { toolbarProps as props, ToolbarProps } from './props';
import { CHANGE_CATALOG_VISIBLE, ON_SAVE } from '@renderer/components/Markdown/MdEditor/static/event-name';
