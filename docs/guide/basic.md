...
```markdown
[duration:3;transition:Colorful;]
...
| ---------------- | -------- | ------ | ---------------------------------------------------------- |
| `duration`       | 持续时间 | `3`    | 秒                                                         |
| `transition`     | 过度动画 | `无`   | 可选值：Colorful WaterWave Stretch BackOff  Fat MoveLeft等 |
| `transitionTime` | 持续时间 | `0.5`  | 秒                                                         |
| `sceneBgColor`   | 背景色   | `#000` |                                                            |
                                                                                                                                                                                                                          

## 关于动画

除了音频以外的场景元素均支持动画，你可在配置页面中选择动画或者自定义动画；
...
| ---------- | -------- | ----------------- | ---------- |
| `color`    | 文本颜色 | `#ffffff`         |            |
| `bgColor`  | 背景颜色 | `rgba(0,0,0,0.3)` | `0` 到 `1` |
| `fontSize` | 字体大小 | `0.04`            | `0` 到 `1` |
